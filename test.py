...
print("path is ",len(DFS(1,6,GetMap()))," spots long")
DrawMap(GetMap(),DFS(1,6,GetMap()))
print("\n")
print("solved with BFS")
print("path is ",len(BFS(1,6,GetMap()))," spots long")
DrawMap(GetMap(),BFS(1,6,GetMap()))
print(BFS(1,6,GetMap()))
